...
public class NiftyInputSystem implements InputSystem {
    ...
    public NiftyInputSystem(final long glfwWindow) {
    ...
    public static class MouseInputEvent {
        ...
        MouseInputEvent(final float mx, final float my, final int scrollY, final int button, final boolean buttonDown) {
            this.mouseX = mx;
            this.mouseY = my;
            this.button = button;
